...
class TestGetConnectionString:
    ...
    def test_generates_connection_string(self):
        ...
        conn = get_connection_string(
            'postgresql://admin:FAKE@host.db.ondigitalocean.com:25060/defaultdb?sslmode=require',
            'tenant1_user',
            'FAKE_TEST_PASS'
        )
    ...
    def test_includes_sslmode(self):
        ...
        conn = get_connection_string(
            'postgresql://admin:FAKE@host:25060/db?sslmode=require',
            'user',
            'FAKE_PASS'
        )
        ...
        with patch.dict('sys.modules', {'psycopg2': mock_psycopg2, 'psycopg2.errors': mock_errors}):
            ...
            with patch('builtins.print'):
                result = add_client.execute_setup(
                    'postgresql://admin:FAKE@invalid/db',
                    'tenant1',
                    'tenant1_user',
                    'FAKE_PASS'
                )
